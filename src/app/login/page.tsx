  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f0f9f4] px-4 relative overflow-hidden">
      ...
      <motion.div whileHover={{ x: -4 }}>
        <Link
          href="/"
          className="absolute top-8 left-8 flex items-center gap-2 text-gray-500 hover:text-green-700 transition font-medium z-10"
        >
      ...
      >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              ...
              <input
                type="email"
                placeholder="Email Address"
                className="w-full pl-12 pr-4 py-4 text-black bg-gray-50 border rounded-2xl outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500"
                value={form.email}
                onChange={(e) => setForm({ ...form, email: e.target.value })}
                required
              />
        ...
        {/* RIGHT IMAGE (FIXED - NO ANIMATION) */}
